...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 105,
    image: 'https://images.unsplash.com/photo-1593085512500-5d55148d6f0d?q=80&w=800&auto=format&fit=crop',
    category: 'Soğuk Kahveler',
  ...
  },
  {
    ...
    description: 'Espresso, çikolata ve süt karışımı.',
    price: 120,
    image: 'https://images.pexels.com/photos/1337397/pexels-photo-1337397.jpeg?auto=compress&cs=tinysrgb&w=800',
    category: 'Soğuk Kahveler',
    tastingNotes: ['Beyaz çikolata', 'Kremsi', 'Tatlı'],
